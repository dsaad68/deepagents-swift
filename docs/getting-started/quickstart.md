...
=== "On-device MLX"
    ...
    `MlxModel.catalog` lists the LFM2.5 family by Hugging Face id: 350M, 1.2B Instruct, 1.2B Thinking, 2.6B (in four precisions), 8B-A1B, and vision variants (450M VL, 1.6B VL). The loader applies each model's recommended sampling parameters automatically.

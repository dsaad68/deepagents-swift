...
public actor SwiftSDKMCPSession: MCPSession {
    ...
    private func makeTransport() throws -> any Transport {
        ...
        case .http:
            ...
            // For `oauth` servers, attach the SDK's OAuth authorizer: it acquires (and refreshes) a
            // Bearer token via the browser sign-in flow, on top of any static headers the user set.
